...
public class PetGUI implements GUI {
    ...
    public void onInventoryClick(InventoryClickEvent e) {
        ...
        if (e.getSlot() == plugin.getInventories().mainMenuBack.slot && plugin.getInventories().mainMenuBackEnabled) {
        ...
        if (slot == plugin.getInventories().convertItemEnabled.slot || slot == plugin.getInventories().convertItemDisabled.slot) {
            itemMode = !itemMode;
