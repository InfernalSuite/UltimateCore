...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public final List<com.infernalsuite.ultimatecore.reforge.commands.Command> commands = new ArrayList<>();
    ...
    public void registerCommand(com.infernalsuite.ultimatecore.reforge.commands.Command command) {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command cmd, @NotNull String label, String[] args) {
        ...
        for (com.infernalsuite.ultimatecore.reforge.commands.Command command : commands) {
