...
public class AnvilGUI {
     ...
     */
    private static VersionWrapper WRAPPER = VersionMatcher.byName();
    ...
    public static class Builder {
        ...
        public AnvilGUI open(Player player) {
            ...
            Validate.notNull(title, "Player cannot be null 2");
            Validate.notNull(itemText, "Player cannot be null 3");
            Validate.notNull(itemLeft, "Player cannot be null 4");
            Validate.notNull(itemRight, "Player cannot be null 5 ");
            Validate.notNull(preventClose, "Player cannot be null 6");
            Validate.notNull(closeListener, "Player cannot be null 7");
            Validate.notNull(inputLeftClickListener, "Player cannot be null 8");
            Validate.notNull(inputRightClickListener, "Player cannot be null 9");
