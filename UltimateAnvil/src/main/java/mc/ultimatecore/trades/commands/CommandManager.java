...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public final List<mc.ultimatecore.trades.commands.Command> commands = new ArrayList<>();
     ...
     */
    public void registerCommand(mc.ultimatecore.trades.commands.Command command) {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command cmd, @NotNull String label, String[] args) {
        ...
        for (mc.ultimatecore.trades.commands.Command command : commands) {
