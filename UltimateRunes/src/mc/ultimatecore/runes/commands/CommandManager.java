...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public final List<mc.ultimatecore.runes.commands.Command> commands = new ArrayList<>();
     ...
     */
    public void registerCommand(mc.ultimatecore.runes.commands.Command command) {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command cmd, @NotNull String label, String[] args) {
        ...
        for (mc.ultimatecore.runes.commands.Command command : commands) {
