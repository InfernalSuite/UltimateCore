...
public abstract class GUI {
    ...
    public GUI(int size, String name) {
        ...
        this.scheduler = Bukkit.getScheduler().scheduleAsyncRepeatingTask(HyperRunes.getInstance(), this::addContent, 0L, 2L);
    }
    ...
    public void addContent() {
        ...
        for (int i = 0; i < this.inventory.getSize(); i++) {
            if (!this.excludedSlots.contains(i) && (
                ...
                setItem(i, InventoryUtils.makeItem((HyperRunes.getInstance().getInventories()).getBackground()));
        }
    }
