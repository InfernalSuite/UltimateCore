...
public class ClipPlaceholderAPIManager extends PlaceholderExpansion {
     ...
     */
    public ClipPlaceholderAPIManager(HyperSouls plugin) {
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, @NotNull String identifier) {
        ...
        switch (identifier) {
            case "collected":
                return plugin.getDatabaseManager().getSoulsData(player.getUniqueId()).getAmount() + "";
            case "total":
                return plugin.getSouls().souls.size() + "";
        }
        return null;
    }
}