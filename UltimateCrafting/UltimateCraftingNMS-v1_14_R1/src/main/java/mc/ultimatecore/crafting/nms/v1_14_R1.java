...
public class v1_14_R1 implements VanillaCraftingSource {
    ...
    public ItemStack[] getRemainingItemsForCrafting(ItemStack[] craftingMatrix, World world) {
        ...
        net.minecraft.server.v1_14_R1.ItemStack[] nmsItems = MinecraftServer.getServer().getCraftingManager().c(Recipes.CRAFTING, crafting, ((CraftWorld) world).getHandle()).toArray(new net.minecraft.server.v1_14_R1.ItemStack[0]);
