...
public class v1_18_R2 implements VanillaCraftingSource {
    ...
    public ItemStack[] getRemainingItemsForCrafting(ItemStack[] craftingMatrix, World world) {
        ...
        net.minecraft.world.item.ItemStack[] nmsItems = MinecraftServer.getServer().aB.b().e().c(Recipes.a, crafting, ((CraftWorld) world).getHandle()).toArray(new net.minecraft.world.item.ItemStack[0]);
