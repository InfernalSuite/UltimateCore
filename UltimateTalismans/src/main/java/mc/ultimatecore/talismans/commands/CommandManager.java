...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public final List<mc.ultimatecore.talismans.commands.Command> commands = new ArrayList<>();
    ...
    public void registerCommand(mc.ultimatecore.talismans.commands.Command command) {
    ...
    public boolean onCommand(CommandSender commandSender, Command cmd, String label, String[] args) {
        ...
        for (mc.ultimatecore.talismans.commands.Command command : commands) {
