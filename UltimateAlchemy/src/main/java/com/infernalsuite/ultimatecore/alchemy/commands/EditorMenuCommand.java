...
import com.infernalsuite.ultimatecore.alchemy.gui.AllRecipesGUI;
...
public class EditorMenuCommand extends Command {
    ...
    public EditorMenuCommand() {
        super(Collections.singletonList("editormenu"), "Open recipes editor menu", "hyperalchemy.editormenu", true);
    }
