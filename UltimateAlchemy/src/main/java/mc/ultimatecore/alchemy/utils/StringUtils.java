...
public class StringUtils {
     ...
     */
    public static List<String> processMultiplePlaceholders(List<String> lines, List<mc.ultimatecore.alchemy.utils.Placeholder> placeholders) {
     ...
     */
    public static String processMultiplePlaceholders(String line, List<mc.ultimatecore.alchemy.utils.Placeholder> placeholders) {
        String processedLine = line;
        for (mc.ultimatecore.alchemy.utils.Placeholder placeholder : placeholders) {
